...
2. **Dual Citation Standards**: When citing source documents, provide both the IDE file link and the macOS Preview link:
   `[CourseCode / FileName.pdf (Page X)](file:///Users/mohit/Documents/moodle-study-tool/output/.../FileName.pdf) ([Open in Preview](open-preview:///Users/mohit/Documents/moodle-study-tool/output/.../FileName.pdf#page=X))`
   This allows users to open the document inside their IDE editor or directly at the exact slide in Apple Preview.

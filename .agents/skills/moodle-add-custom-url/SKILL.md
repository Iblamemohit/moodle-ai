...
2. **Execute Registration & Auto-Sync**:
   - Run:
     ```bash
     .venv/bin/python agent_tools.py /add-custom-url "<TARGET_URL>" "<OPTIONAL_LABEL>"
     ```
...
3. **Report Status**:
   ...
   - Provide a clickable link to [`list.md`](file:///Users/mohit/Documents/moodle-study-tool/list.md).

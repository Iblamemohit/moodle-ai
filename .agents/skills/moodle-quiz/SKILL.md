...
4. After the student answers, explain whether they were correct, provide the full explanation, and cite the exact slide using dual citations: `[CourseCode / FileName.pdf (Page X)](file:///Users/mohit/Documents/moodle-study-tool/output/.../FileName.pdf) ([Open in Preview](open-preview:///Users/mohit/Documents/moodle-study-tool/output/.../FileName.pdf#page=X))`.

...
4. After the student answers, explain whether they were correct, provide the full explanation, and cite the exact slide using Preview links: `[CourseCode / FileName.pdf (Page X)](open-preview:///path/to/output/.../FileName.pdf#page=X)`.
5. You can also offer to open the source slide in macOS Preview using `.venv/bin/python agent_tools.py /open "<FILENAME>" <PAGE>`.
